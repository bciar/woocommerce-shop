 ...
 */
class pakkelabels_shipping_bring_private extends Pakkelabels_Shipping_Main
{
    ...
    {
        $this->id                 = 'pakkelabels_shipping_bring_private';
    ...
    function pakkelabels_shipping_checkout_update_order_meta_bring_method_private($order_id)
    {
        ...
        if ($choosen_shipping_method1 == 'pakkelabels_shipping_bring_private' || $choosen_shipping_method2 == 'pakkelabels_shipping_bring_private') {
    ...
    {
        $methods['pakkelabels_shipping_bring_private'] = 'pakkelabels_shipping_bring_private';
        return $methods;
    }
}


$Pakkelabels_bring_Private = new pakkelabels_shipping_bring_private();
$Pakkelabels_bring_Private->mainAddAction();
$Pakkelabels_bring_Private->addActions();
$Pakkelabels_bring_Private->addFilters();