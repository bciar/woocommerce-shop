 ...
 */
class Pakkelabels_Shipping_GLS_Private extends Pakkelabels_Shipping_Main
{
    ...
    {
        $this->id                 = 'pakkelabels_shipping_gls_private';
        $this->instance_id        = absint($instance_id);
        $this->method_title       = __('GLS Private', 'woocommerce-pakkelabels');
        $this->method_description = __('Adds the option to ship with the GLS private in the checkout', 'woocommerce-pakkelabels');
        $this->supports              = array(
            'shipping-zones',
            'instance-settings',
        );
    ...
    function pakkelabels_shipping_checkout_update_order_meta_gls_method_private($order_id)
    {
        ...
        if ($choosen_shipping_method1 == 'pakkelabels_shipping_gls_private' || $choosen_shipping_method2 == 'pakkelabels_shipping_gls_private') {
    ...
    {
        $methods['pakkelabels_shipping_gls_private'] = 'Pakkelabels_Shipping_GLS_Private';
        return $methods;
    }
}


$Pakkelabels_GLS_Private = new Pakkelabels_Shipping_GLS_Private();
$Pakkelabels_GLS_Private->mainAddAction();
$Pakkelabels_GLS_Private->addActions();
$Pakkelabels_GLS_Private->addFilters();